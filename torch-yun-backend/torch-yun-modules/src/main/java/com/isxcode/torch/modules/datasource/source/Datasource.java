package com.isxcode.torch.modules.datasource.source;

import com.isxcode.torch.api.datasource.constants.ColumnType;
...
import com.isxcode.torch.api.datasource.dto.SecurityColumnDto;
...
import com.isxcode.torch.modules.datasource.service.DriverShim;
...
import static com.isxcode.torch.modules.datasource.service.DatasourceService.ALL_EXIST_DRIVER;
    ...
    public Connection getConnection(ConnectInfo connectInfo) throws IsxAppException {
        ...
        if (driver == null) {
            ...
            if (isxAppProperties.isDockerMode()) {
                driverPath = "/var/lib/zhishuyun-system/" + driverEntity.getFileName();
            }
