...
@Service
@Slf4j
public class DeepSeek extends Bot {

    private final ChatSessionRepository chatSessionRepository;

    public DeepSeek(ChatSessionRepository chatSessionRepository) {
    ...
    public void chat(BotChatContext botChatContext, SseEmitter sseEmitter) {
        ...
        String pythonScriptPath = "/Users/ispong/isxcode/torch-yun/torch-yun-vip/torch-yun-plugins/deepseek/ai.py";
