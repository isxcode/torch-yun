...
public class Doubao extends Bot {
    ...
    public Doubao(ChatSessionRepository chatSessionRepository) {
    ...
    public void chat(BotChatContext botChatContext, SseEmitter sseEmitter) {
        ...
        String pythonScriptPath = "/Users/ispong/isxcode/torch-yun/torch-yun-vip/torch-yun-plugins/doubao/ai.py";
