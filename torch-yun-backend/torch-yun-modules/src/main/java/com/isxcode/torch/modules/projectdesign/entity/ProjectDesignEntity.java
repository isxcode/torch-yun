package com.isxcode.torch.modules.projectdesign.entity;
...
@Data
@Entity
@SQLDelete(sql = "UPDATE TY_PROJECT_DESIGN SET deleted = 1 WHERE id = ? and version_number = ?")
@Where(clause = "deleted = 0 ${TENANT_FILTER} ")
@Table(name = "TY_PROJECT_DESIGN")
@JsonIgnoreProperties({"hibernateLazyInitializer"})
@EntityListeners(AuditingEntityListener.class)
public class ProjectDesignEntity {
