package com.isxcode.torch.modules.datasource.entity;
...
@NoArgsConstructor
@AllArgsConstructor
@SQLDelete(sql = "UPDATE TY_DATABASE_DRIVER SET deleted = 1 WHERE id = ? and version_number = ?")
@Where(clause = "deleted = 0 ${TENANT_FILTER} ")
@Table(name = "TY_DATABASE_DRIVER")
