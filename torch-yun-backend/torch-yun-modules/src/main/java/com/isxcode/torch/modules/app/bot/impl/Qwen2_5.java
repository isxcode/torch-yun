...
//
// public Qwen2_5(ChatSessionRepository chatSessionRepository, ClusterNodeRepository
...
// ChatAgentAiReq.builder().topK(botChatContext.getBaseConfig().getTopK())
...
// content = "智能体已停用";
// } else {
// content = JSON.parseObject(JSON.toJSONString(baseResponse.getData()),
// ChatAgentAiRes.class).getResponse();
// }
//
// // 推送SSE消息 - 分块发送大内容
// try {
