export default defineNuxtPlugin({
  ...
  setup() {
    if (process.client) {
      // 关键背景图（优先加载并显示）
      const criticalBackgroundUrl = 'https://zhishuyun-demo.isxcode.com/tools/open/file/bg-0.jpg';

      // 其他资源配置（bg-0.jpg 加载完成后再加载）
      const orderedResources = [
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/bg-0.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/logo.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/product.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/t-0.png', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/t-1.png', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/t-2.png', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/t-3.png', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/t-4.png', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/t-5.png', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/p-0.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/p-1.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/p-2.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/p-3.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/p-4.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/bg-1.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/bg-2.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/qrcode.jpg', type: 'image' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/AlimamaShuHeiTi-Bold.woff2', type: 'font' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/AlibabaPuHuiTi-2-45-Light.woff2', type: 'font' },
        { url: 'https://zhishuyun-demo.isxcode.com/tools/open/file/product.mp4', type: 'video' }
      ];
