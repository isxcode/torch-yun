...
```json
{
  "spark.kubernetes.driver.podTemplateFile":"/home/zhishuyun/pod-init.yaml",
  "spark.kubernetes.executor.podTemplateFile":"/home/zhishuyun/pod-init.yaml"
}
```

```bash
vim /home/zhishuyun/pod-init.yaml
```
...
> 查看本地zhishuyun的uid，将容器的权限设置一致

```bash
sudo cat /etc/group
```

> 获取zhishuyun的uid是1000
...
> runAsUser: 1000 需要和zhishuyun的uid一致
