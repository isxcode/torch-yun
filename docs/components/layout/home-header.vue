    ...
    <div class="content">
      <div class="right">
        <div @click="handleLogoClick" class="home-header-logo">
          <div class="logo">
            <img
              src="https://zhishuyun-demo.isxcode.com/tools/open/file/logo.jpg"
              alt=""
            />
...
const menuData: Array<MenuData> = reactive([
  {
    title: "github",
    icon: "github",
    path: "https://github.com/isxcode/torch-yun",
    type: "link",
  },
]);
    ...
    .menu {
      ...
      :deep(.lang-switcher) {
        ...
        .lang-options {
          ...
          .lang-option {
            &.active {
              background-color: rgb(220 234 254 / 30%);
              color: #506bfe;
              font-weight: 500;
            }
          }
        ...
        :deep(.lang-switcher) {
          ...
          .lang-options {
            ...
            .lang-option {
              &.active {
                background-color: rgb(220 234 254 / 30%);
                color: var(--sk-color-home-primary, #506bfe);
                font-weight: 500;
              }
            }
          }
