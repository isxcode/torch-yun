<template>
  <div class="footer">
    ...
    <div class="content">
      <div class="left">
        ...
        <img class="wechat-img" src="https://zhishuyun-demo.isxcode.com/tools/open/file/wx_qrcode.jpg" alt=""/>
  ...
  >
    <div class="license-dialog-content">
      <img class="license-qrcode" src="https://zhishuyun-demo.isxcode.com/tools/open/file/qrcode.jpg" alt="微信公众号二维码"/>
