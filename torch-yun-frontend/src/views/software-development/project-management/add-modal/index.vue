<template>
  <BlockModal :model-config="modelConfig">
    <el-form ref="form" class="add-project" label-position="top" :model="formData" :rules="rules">
      ...
      <el-form-item label="设计模型应用" prop="designAppId"><el-select v-model="formData.designAppId" placeholder="请选择"><el-option v-for="item in appList" :key="item.id" :label="item.name" :value="item.id" /></el-select></el-form-item>
      <el-form-item label="计划模型应用" prop="planAppId"><el-select v-model="formData.planAppId" placeholder="请选择"><el-option v-for="item in appList" :key="item.id" :label="item.name" :value="item.id" /></el-select></el-form-item>
      <el-form-item label="开发模型应用" prop="developAppId"><el-select v-model="formData.developAppId" placeholder="请选择"><el-option v-for="item in appList" :key="item.id" :label="item.name" :value="item.id" /></el-select></el-form-item>
